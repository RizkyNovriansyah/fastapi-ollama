...
# STEP 1 — Tanya LLM
prompt = """
Berikan 3 tempat makan nasi goreng enak di Jakarta.
"""

llm_output = ask_llm(prompt)
# llm_output = """
# I'm happy to help! Here are three recommendations for popular ramen places in Jakarta, along with their locations:

# 1. Totto Ramen — A well-known and loved ramen spot in Jakarta.
# Location: {{TEMPAT:Totto Ramen Jakarta}}

# 2. Ichiran Ramen — A unique and flavorful ramen experience in Jakarta.
# Location: {{TEMPAT:Ichiran Ramen Jakarta}}

# 3. Hakata Gion — A popular spot for Tonkotsu Ramen in Jakarta, with a rich pork broth and springy noodles.
# Location: {{TEMPAT:Hakata Gion Jakarta}}

# Please note that the locations are subject to change, and it's always best to double-check with online maps or call ahead to confirm.
# """
print("\n=== OUTPUT LLM ===")
print(llm_output)

# STEP 3 — Panggil Google Maps
print("\n=== HASIL GOOGLE MAPS ===")
...
final_output = replace_tempat_placeholders(llm_output)
print(final_output)